...
export function CarouselWithContent() {
  return (
    <Carousel transition={{ duration: 2 }} className="absolute top-0 h-full w-full bg-cover bg-center opacity-90">
        ...
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/75">
          ...
          <Typography
            ...
            <div className="flex justify-center gap-2">
              ...
              <Button className="flex items-center gap-3" size="md" color="white" variant="text">
